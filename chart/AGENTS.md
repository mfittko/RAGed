...
All Kubernetes resources use the pattern: `{{ .Release.Name }}-<component>` (e.g., if release name is `my-raged`, resources are named `my-raged-api`, `my-raged-postgres`, etc.).
